...
func main() {
  ...
  msg = []byte{0x52, 0x7c, 0x37}
	msg = createMessage(msg, '2')
	send(s, msg)
  ...
  msg = []byte{0x33, 0x36, 0x30, 0x32, 0x7c, 0x33, 0x34, 0x30, 0x30, 0x31, 0x36, 0x33, 0x37}
	msg = createMessage(msg, '3')
	send(s, msg)
...
func createMessage(data []byte, frameNumber byte) []byte {
